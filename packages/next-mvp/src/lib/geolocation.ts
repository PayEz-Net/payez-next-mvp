...
const geoCache = new Map<string, { location: LocationInfo | null; timestamp: number }>();
 ...
 */
export async function getLocationFromIP(ip: string, resolvePublicIP: boolean = true): Promise<LocationInfo | null> {
...
export function getCountryFlag(countryCode?: string): string {
  if (!countryCode || countryCode === 'LO') return '🏠'; // Local/development
